...
Deployment trust boundaries and known production blockers are documented in [docs/threat-model.md](docs/threat-model.md) and [docs/production-security-readiness.md](docs/production-security-readiness.md). Production data handling is defined in [docs/production-data-governance.md](docs/production-data-governance.md). Operators must follow [docs/security-review.md](docs/security-review.md) before every Staging or Production promotion. Never attach raw logs, task bodies, repository content, backup files, or Run artifacts to a vulnerability report; provide redacted hashes and the minimum reproduction instead.
