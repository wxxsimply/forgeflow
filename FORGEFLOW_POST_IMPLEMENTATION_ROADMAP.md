...
| 4 Prompt/模型治理 | 进行中 | 仓库所有者 | 2026-09-01 |  | `docs/stage-4-prompt-model-governance-audit.md`、`docs/stage-4-developer-prompt-v2-candidate.md`、`docs/stage-4-developer-v2-eval-runbook.md`、`docs/stage-4-governance-drill-runbook.md`；PR #14/#15/#20/#21/#22/#23/#24 已合并且四项必需检查通过，下一步执行受控 Developer v1/v2 正式 Eval、Admin 人工批准和双版本 Promotion/rollback 演练 |
| 5 不可变发布镜像 | 未开始 | 待填写 |  |  |  |
